...
#| fig-cap: Comparison of Actual and Estimated Total Respondents by State using the Ratio Estimator Method
#| echo: false
...
ggplot(comparison, aes(x = reorder(STATEICP, -actual_total))) +
  ...
  labs(title = "Comparison of Actual and Estimated Totals by State",
       x = "State", y = "Total Counts") +
